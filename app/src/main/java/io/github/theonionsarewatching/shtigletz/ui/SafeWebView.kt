...
class SafeWebView @JvmOverloads constructor(
    ...
    fun showPlaceholder(text: String) {
        ...
        val doc = "<html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">" +
                "<style>body{font-family:sans-serif;font-size:16px;margin:8px;color:#888;}</style></head>" +
